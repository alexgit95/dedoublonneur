...
- **THEN** the system recomputes and re-displays the duplicate and near-duplicate groups using the new threshold without changing the stored job default or re-analyzing photos
